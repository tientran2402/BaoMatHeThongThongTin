# Form implementation generated from reading ui file 'UI\ui_GiaiMaChuyenVi.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(248, 232, 238);\n"
"")
        MainWindow.setIconSize(QtCore.QSize(24, 24))
        self.centralwidget = QtWidgets.QWidget(parent=MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox_4 = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(20, 130, 121, 171))
        self.groupBox_4.setObjectName("groupBox_4")
        self.pB_GiaiMa = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_GiaiMa.setGeometry(QtCore.QRect(20, 30, 81, 31))
        self.pB_GiaiMa.setStyleSheet("background-color: rgb(126, 23, 23);\n"
"color: rgb(255, 255, 255);")
        self.pB_GiaiMa.setObjectName("pB_GiaiMa")
        self.pB_Refresh = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_Refresh.setGeometry(QtCore.QRect(20, 80, 81, 31))
        self.pB_Refresh.setStyleSheet("background-color: rgb(126, 23, 23);\n"
"color: rgb(255, 255, 255);")
        self.pB_Refresh.setObjectName("pB_Refresh")
        self.pB_LuuFile = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_LuuFile.setGeometry(QtCore.QRect(20, 130, 81, 31))
        self.pB_LuuFile.setStyleSheet("background-color: rgb(126, 23, 23);\n"
"color: rgb(255, 255, 255);")
...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 90, 71, 21))
...
"font: 75 12pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Giải mã chuyển vị nhiều dòng"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Chức năng"))
        self.pB_GiaiMa.setText(_translate("MainWindow", "Giải mã"))
        ...
        self.label_2.setText(_translate("MainWindow", "Nội dung"))
