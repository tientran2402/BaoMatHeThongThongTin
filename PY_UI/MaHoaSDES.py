# Form implementation generated from reading ui file 'UI\ui_MaHoaSDES.ui'
#
...
"")
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(20, 100, 121, 181))
        self.groupBox_4.setObjectName("groupBox_4")
        self.pB_MaHoa = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_MaHoa.setGeometry(QtCore.QRect(20, 20, 81, 31))
        self.pB_MaHoa.setStyleSheet("background-color: rgb(0, 170, 255);\n"
"color: rgb(255, 255, 255);")
        self.pB_MaHoa.setObjectName("pB_MaHoa")
        self.pB_Refresh = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_Refresh.setGeometry(QtCore.QRect(20, 70, 81, 31))
        self.pB_Refresh.setStyleSheet("background-color: rgb(0, 170, 255);\n"
"color: rgb(255, 255, 255);")
        self.pB_Refresh.setObjectName("pB_Refresh")
        self.pB_LuuFile = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.pB_LuuFile.setGeometry(QtCore.QRect(20, 120, 81, 31))
        self.pB_LuuFile.setStyleSheet("background-color: rgb(0, 170, 255);\n"
"color: rgb(255, 255, 255);")
...
"font: 75 12pt \"MS Shell Dlg 2\";")
        ...
        self.tB_Content.setGeometry(QtCore.QRect(160, 100, 461, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Mã Hóa SDES"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Chức năng"))
        self.pB_MaHoa.setText(_translate("MainWindow", "Mã hóa"))
